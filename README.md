...
IPNetwork utility classes take care of complex network, ip, netmask, subnet, cidr calculation for .Net developpers. It works with IPv4, it is written in C# and has a light and clean API and is fully unit tested.
