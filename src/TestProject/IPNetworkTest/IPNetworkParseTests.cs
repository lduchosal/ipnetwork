...
public class IPNetworkParseTests
{
    ...
    /// </summary>
    [TestMethod]
    public void TestParseShouldReturnFalseWhenParsingACidrWithExtraCharacters()
    {
        bool result = IPNetwork2.TryParse("20.42.65.64/29 !%!!!!!", false, out _);
    ...
    /// </summary>
    [TestMethod]
    public void TestParseShouldReturnTrueWhenParsingACidrWithExtraCharacters()
    {
        bool result = IPNetwork2.TryParse("20.42.65.64/29 !%!!!!!", true, out _);
